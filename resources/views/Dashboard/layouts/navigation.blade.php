                  ...
                  <li class="nav-item dropdown">
                      <a class="nav-link dropdown-toggle text-muted pr-0" href="#" id="navbarDropdownMenuLink"
                          ...
                          <span class="avatar avatar-sm mt-2">
                              <img src="{{ asset('dashboard/assets/avatars/face-1.jpg') }}" alt="..."
          ...
          <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
              ...
              <nav class="vertnav navbar navbar-light">
                  ...
                  <ul class="navbar-nav flex-fill w-100 mb-2">
                      <li class="nav-item dropdown">
                          <a href="{{ route('about.create') }}" data-toggle="collapse" aria-expanded="false"
                              class="dropdown-toggle nav-link">
                              <i class="fe fe-home fe-16"></i>
                              <span class="ml-3 item-text">About section</span><span class="sr-only">(current)</span>
                          </a>
                  ...
                  <ul class="navbar-nav flex-fill w-100 mb-2">
                      <li class="nav-item dropdown">
                          <a href="{{ route('clients.create') }}" data-toggle="collapse" aria-expanded="false"
                              class="dropdown-toggle nav-link">
                              <i class="fe fe-box fe-16"></i>
                              <span class="ml-3 item-text">Client Section</span>
                          </a>
                      ...
                      <li class="nav-item w-100">
                          <a class="nav-link" href="{{ route('services.create') }}">
                              ...
                              <span class="ml-3 item-text">Service Section</span>
                              <span class="badge badge-pill badge-primary">New</span>
                          </a>
                      </li>
                      <li class="nav-item dropdown">
                          <a href="{{ route('projects.create') }}" data-toggle="collapse" aria-expanded="false"
                              class="dropdown-toggle nav-link">
                              <i class="fe fe-credit-card fe-16"></i>
                              <span class="ml-3 item-text">Projects section</span>
                          </a>
                      ...
                      <li class="nav-item dropdown">
                          <a href="{{ route('contact.create') }}" data-toggle="collapse" aria-expanded="false"
                              class="dropdown-toggle nav-link">
                              <i class="fe fe-grid fe-16"></i>
                              <span class="ml-3 item-text">Contact section</span>
                          </a>
                      ...
                      <li class="nav-item dropdown">
                          <a href="{{ route('change.contact') }}" data-toggle="collapse" aria-expanded="false"
                              class="dropdown-toggle nav-link">
                              <i class="fe fe-pie-chart fe-16"></i>
                              <span class="ml-3 item-text">contact changes</span>
                          </a>
                  ...
                  <ul class="navbar-nav flex-fill w-100 mb-2">
                      <li class="nav-item w-100">
                          <a class="nav-link" href="{{ route('change.index') }}">
                              <i class="fe fe-calendar fe-16"></i>
                              <span class="ml-3 item-text">Changes in Index</span>
                          </a>
                      </li>
                      <li class="nav-item dropdown">
                  ...
                  <ul class="navbar-nav flex-fill w-100 mb-2">
                      ...
                      <li class="nav-item dropdown">
                          ...
                          <ul class="collapse list-unstyled pl-4 w-100" id="auth">
                              <a class="nav-link pl-3" href="./auth-login.html"><span class="ml-1">Login
                                      1</span></a>
